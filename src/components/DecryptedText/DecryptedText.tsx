...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    characters, useOriginalCharsOnly
  ]);
  ...
  /* Sync animateOn/click initial state */
  useEffect(() => {
  ...
  return (
    <motion.span
      ...
      {...props}
    >
      {/* Screen-reader sees the real text */}
      <span style={inlineStyles.srOnly}>{text}</span>

      {/* Visual scramble output — hidden from a11y tree */}
